...
from chat.utils import OptimizationProblemUtil
...
def chat(question: str,historyId:int,username:str):
    ...
    for i in history_list:
        messages.append({'role':'user','content':i.get('question')})
        messages.append({'role':'system','content':i.get('answer')})

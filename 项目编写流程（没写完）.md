...
![image-20260812102915156](项目编写流程（没写完）.assets/image-20260812102915156.png)
...
![image-20260812153724741](项目编写流程（没写完）.assets/image-20260812153724741.png)

添加测试用户：

![image-20260812153907654](项目编写流程（没写完）.assets/image-20260812153907654.png)
...
![image-20260812113101885](项目编写流程（没写完）.assets/image-20260812113101885.png)

创建成功：项目会自动启动，通过给出的地址可以访问到内容

![image-20260812113228643](项目编写流程（没写完）.assets/image-20260812113228643.png)
...
![image-20260812114251888](项目编写流程（没写完）.assets/image-20260812114251888.png)
...
![image-20260812134913979](项目编写流程（没写完）.assets/image-20260812134913979.png)
...
![image-20260812161544558](项目编写流程（没写完）.assets/image-20260812161544558.png)
